...
@interface ZhaoMiMaViewController ()

@end

@implementation ZhaoMiMaViewController
@synthesize start;
...
-(void)httpASi
{
    ...
    NSString * rsaString = [NSString stringWithFormat:@"http://139.210.99.29:83/index.php/home/regedit/get_pass?types=1&content=%@",UserName.text];
...
#define IOS7_OR_LATER   ( [[[UIDevice currentDevice] systemVersion] compare:@"7.0"] != NSOrderedAscending )
    ...
    UserName=[[UITextField alloc]initWithFrame:CGRectMake(70, 50, 180, 40)];
    UserName.placeholder=@"请输入用户名";
    UserName.font=[UIFont fontWithName:@"Arial" size:15];
...
-(BOOL)textFieldShouldReturn:(UITextField *)textField
{
    ...
    UserName.frame =CGRectMake(70, 50, 180, 40);
